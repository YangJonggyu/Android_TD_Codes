...
public class NestedScrollManager : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    void Update()
    {
        ...
        if (!isDrag)
        {
            scrollbar.value = Mathf.Lerp(scrollbar.value, targetPos, 0.2f);
        ...
        for (int i = 0; i < SIZE; i++)
        {
            ...
            BtnImageRect[i].transform.GetChild(1).gameObject.SetActive(textActive);
        }
    }
